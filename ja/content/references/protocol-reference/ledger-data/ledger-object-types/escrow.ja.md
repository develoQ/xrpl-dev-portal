...
* The Sequence number of the \[EscrowCreate transaction\]\[\] that created the `Escrow` object If the EscrowCreate transaction used a [Ticket](tickets.html), use the `TicketSequence` value instead.
