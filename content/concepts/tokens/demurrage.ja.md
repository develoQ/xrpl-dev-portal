...
**ヒント:** デマレージはインフレに似ていると考えることができます。 インフレの影響を受けたすべての資産の価値は時間とともに減少しますが、レジャーには常に2000年の値で金額が記録されます。 This does not show actual real-world inflation; demurrage is more like hypothetical inflation at a constant rate.
...
2. The next 24 bits represent 3 characters of ASCII. This is expected to be an ISO 4217 code. 標準フォーマットのASCII文字と同じ文字をサポートしています。
