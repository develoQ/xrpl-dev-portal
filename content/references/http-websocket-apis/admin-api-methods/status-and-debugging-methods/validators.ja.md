...
| `Field`                  | 型      | 説明                                                                                                                                                                                                                                                |
|:------------------------ |:------ |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `listed_static_keys`     | 配列     | Array of public keys for validators explicitly trusted in the config file.                                                                                                                                                                        |
| `publisher_lists`        | 配列     | Array of **Publisher List** objects. (See below for details.)                                                                                                                                                                                     |
| `signing_keys`           | オブジェクト | Mapping from master public key to current ephemeral public key for all currently-trusted validators. Excludes validators that don't use an ephemeral signing key.                                                                                 |
...
| `validator_list_expires` | 文字列    | The human readable time when the current validator list expires. There are two special cases: the string `unknown` if the server has not yet loaded a published validator list, or the string `never` if the server uses a static validator list. |
...
| `list`             | 配列     | Array of published validator keys in the list.             |
