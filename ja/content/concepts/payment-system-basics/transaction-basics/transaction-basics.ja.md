...
For more information about master and regular key pairs, see [Cryptographic Keys](cryptographic-keys.html).<!--{# Add this reference after signatures concept doc is published. For more information about signatures, see \[Understanding Signatures\](concept-signatures.html). #}-->## Signing and Submitting Transactions
